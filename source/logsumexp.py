...
if __name__ == '__main__':
    ...
    # run this in debug mode to see what happens to the contributions to the values < 1 in the logsumexp calculation and
    # also what happens to the softmax probability distribution
    _run_example(0, [1000, 1e-5, 1e-10])
    _run_example(1, [10, 1e-5, 1e-10])
    _run_example(2, [10, 1e-5, 1e-10])